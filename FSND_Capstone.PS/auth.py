...
"""
Methods are similar to the coffeeshop project, so double checked the following sources:
...
def verify_decode_jwt(token):
    ...
    if rsa_key:
        try:
            ...
            raise AuthError({
                'code': 'invalid_header',
                'description': 'unable to parse authenication token'
                }, 400)
